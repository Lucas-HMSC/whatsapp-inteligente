        ...
        <ul>
            ...
            <div align="center">
                <figure>
                    ...
                    <br />
                    <figcaption style="font-size: 8px;">Nesse caso, meu número estava presente na lista de contatos. Se não estivesse, apareceria 'Lucas Carvalho' (nome atribuído a minha conta).</figcaption>
                </figure>
            </div>
